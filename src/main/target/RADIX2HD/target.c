...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    //DEF_TIM(TIM12, CH2, PB15,  TIM_USE_LED,                TIMER_OUTPUT_INVERTED,  8,  0 ), // LED Strip

    DEF_TIM(TIM1,  CH1, PE9,   TIM_USE_MOTOR,               0,  0,  0 ), // S1
	DEF_TIM(TIM1,  CH3, PE13,  TIM_USE_MOTOR,               0,  1,  0 ), // S2
	DEF_TIM(TIM2,  CH1, PA15,  TIM_USE_MOTOR,               0,  2,  0 ), // S3
    DEF_TIM(TIM2,  CH2, PB3,   TIM_USE_MOTOR,               0,  3,  0 ), // S4

    DEF_TIM(TIM3,  CH2, PA7,   TIM_USE_MOTOR,               0,  4,  2 ), // S5
    DEF_TIM(TIM3,  CH3, PB0,   TIM_USE_MOTOR,               0,  5,  2 ), // S6
    DEF_TIM(TIM4,  CH3, PD14,  TIM_USE_MOTOR,               0,  6,  1 ), // S7
    //DEF_TIM(TIM4,  CH4, PD15,  TIM_USE_MOTOR,               0,  7,  1 ), // S8
...
const timerHardware_t timerHardwareRgbLed[3] = {
    ...
    DEF_TIM(TIM5, CH2, PA1, TIM_USE_NONE, TIMER_OUTPUT_INVERTED,  0,  0 ), // G
    DEF_TIM(TIM5, CH3, PA2, TIM_USE_NONE, TIMER_OUTPUT_INVERTED,  0,  0 ), // B
};
#endif
